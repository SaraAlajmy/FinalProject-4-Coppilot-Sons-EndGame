...
public class NotificationTestService {
    ...
    public void disableNotification(String notificationType, String strategyType) {
        given()
            ...
            .when()
            .post(
                "/api/notification-settings/" + notificationType + "/" + strategyType + "/disable")
            .then()
            .statusCode(200);
    }
    ...
    public void updateNotification(String notificationId, Map<String, Object> updatedNotification) {
        given()
            .spec(notificationServiceSpec)
            .contentType(ContentType.JSON)
