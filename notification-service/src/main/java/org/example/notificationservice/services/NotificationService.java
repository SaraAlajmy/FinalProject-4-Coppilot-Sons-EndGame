...
public class NotificationService {
    ...
    public boolean createNotification(Notification notification) {
        ...
        for (String strategyType : NotificationStrategyType.getAllTypes()) {
            if(notificationSettingsService.isNotificationEnabled(notification.getRecipientUserId(),
                ...
                if(!notificationDeliveryService.deliverNotificationUsingStrategy(
                    ...
                    success = false;
                    log.error("Failed to deliver Notification of type {} using strategy {} for recipient {}",notification.getType(), strategyType, notification.getRecipientUserId());
                }
